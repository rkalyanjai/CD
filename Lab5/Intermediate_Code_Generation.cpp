...
// Alg
- Start the process.
- Input an expression EXP from user.
- Process the expression from right hand side to left hand side.
- FLAG:=0; TOP = -1;
- IF EXP = ‘=’ then
     i. IF EXP(index – 1) = 0 then
        1. PRINT EXP element from index to (index – 1) and POP STACK[TOP].
        Terminate
  Else
